...
from embedding_generation.data.word2vec_input import transform_hex_data
...
def word2vec_pipeline(
    ...
    samples_and_sample_train_samples = transform_hex_data(params, samples_and_sample_train_samples)

    samples_and_sample_test_samples = samples_and_sample_str_test.sample
    samples_and_sample_test_samples = transform_hex_data(params, samples_and_sample_test_samples)
